...
RUN cd /opt && curl --retry 8 -s -L -O https://artifacts.elastic.co/downloads/kibana/kibana-7.9.3-linux-aarch64.tar.gz && cd -

RUN mkdir /usr/share/kibana
WORKDIR /usr/share/kibana

# RUN tar --strip-components=1 -zxf /opt/kibana-7.9.3-linux-x86_64.tar.gz
RUN tar --strip-components=1 -zxf /opt/kibana-7.9.3-linux-aarch64.tar.gz
